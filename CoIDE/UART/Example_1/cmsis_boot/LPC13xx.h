...
#define   UART_TypeDef     LPC_UART_TypeDef
#define   I2C_TypeDef      LPC_I2C_TypeDef
#define   WDT_TypeDef      LPC_WDT_TypeDef
#define   TMR_TypeDef      LPC_TMR_TypeDef
#define   ADC_TypeDef      LPC_ADC_TypeDef
#define   PMU_TypeDef      LPC_PMU_TypeDef
#define   SSP_TypeDef      LPC_SSP_TypeDef
#define   IOCON_TypeDef    LPC_IOCON_TypeDef
#define   SYSCON_TypeDef   LPC_SYSCON_TypeDef
#define   USB_TypeDef      LPC_USB_TypeDef
